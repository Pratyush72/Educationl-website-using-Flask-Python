...
def html():
    ...
    return render_template('html_notes.html')
...
def ml():
    ...
    return render_template('ml_notes.html')
...
def nlp():
    ...
    return render_template('nlp_notes.html')
@app.route('/css', methods=['GET','POST'])
def css():

    return render_template('css_notes.html')
...
def c():
    ...
    return render_template('c_notes.html')

@app.route('/js', methods=['GET','POST'])
def js():

    return render_template('js_notes.html')
